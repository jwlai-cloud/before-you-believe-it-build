...
for (const token of ['Think', 'Push back', 'Check', 'Make', 'Own', 'LEARNING RECEIPT', 'Copy working answer', 'Print / save receipt', 'Why this exists', 'LIVE GPT · REVIEWER DEMO', 'Judge access code']) {
