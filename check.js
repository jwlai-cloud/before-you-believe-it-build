...
for (const token of ['Think', 'Push back', 'Check', 'Make', 'Own', 'LEARNING RECEIPT', 'Copy working answer', 'Print / save receipt', 'data-purpose-note', 'data-live-reviewer-demo', 'Judge access code']) {
